...
class TweetCell: DatasourceCell {
    ...
    fileprivate func setupBottomButtons() {
        let replyButtonContanerView = UIView()
        let retweetButtonContainerView = UIView()
        let likeButtonContainerView = UIView()
        let directMessageButtonContainerView = UIView()
        
        let buttonStackView = UIStackView(arrangedSubviews: [replyButtonContanerView, retweetButtonContainerView, likeButtonContainerView, directMessageButtonContainerView])
        ...
        replyButton.anchor(replyButtonContanerView.topAnchor, left: replyButtonContanerView.leftAnchor, bottom: nil, right: nil, topConstant: 0, leftConstant: 0, bottomConstant: 0, rightConstant: 0, widthConstant: 20, heightConstant: 20)
